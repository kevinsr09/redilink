...
var pisma_1 = require("@redilink/core/dist/shared/infrastructure/persistence/pisma");
var DomainError_1 = require("@redilink/core/dist/shared/domain/DomainError");
var Server = /** @class */ (function () {
    function Server(_a) {
        var port = _a.port;
        this.express = (0, express_1.default)();
        this.port = port;
        this.db = new pisma_1.PrismaDatabase();
        ...
        router.use(function (_err, _req, res, next) {
            console.log(_err);
    ...
    Server.prototype.listen = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.conectDatabase()];
                    case 1:
                        _a.sent();
    ...
    Server.prototype.conectDatabase = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
